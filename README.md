...
## Visual Identity
The interface has a **Grass & Nature** design

* **Primary Pallete:** Green and white to create the grass and nature of grass field
* **Typography:** The text are clearly brought out and clear using various styles

## Current Features (Frontend)

* **Turf display:** Showcases various playfields in the country and their location
* **Responsive Layout:**  Can be used on any devices
* **Navigation:** Its has a navigation bar that leads you to the exact page you would like
* ** Search Interface:** Allows users to look for the place and location of their liking

### Dashboard & Analytics
- Admin dashboard with system overview
- Game insights (Games, Tournaments,)
- Activity logs
...
To bring together soccer players and lovers to enable the sport to grow which is not only a sport but an art.
